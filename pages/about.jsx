...
export default function About() {
  return (
    <Layout>
      ...
      <p className="text-lg text-white mb-6">I completed my SSC from MIT Vishwashanti Gurukul School, Chatrapati ti Sambhajinagar and HSC from DES, High School & Jr. College, Malkapur.</p>
...
<Image
  ...
  style={{
    ...
    height: "auto"
      ...
      <p className="text-lg text-white">Follow me on <Link href="https://instagram.com/iambhvsh" className="text-blue-500 hover:underline">Instagram</Link> & <Link href="https://github.com/iambhvsh" className="text-blue-500 hover:underline">Github</Link></p>
    </div>
      </Container>
    </Layout>
  );
